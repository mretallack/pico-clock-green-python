from constants import CONFIGURATION_FILE, CONFIGURATION_RUN_BLINK_TIME_COLON, CONFIGURATION_RUN_CLOCK_TYPE, CONFIGURATION_RUN_AUTOLIGHT
from constants import CONFIGURATION_RUN_SHOW_TEMP, CONFIGURATION_RUN_SHOW_STATUS, CONFIGURATION_RUN_STATUS_PERIOD, CONFIGURATION_MQTT_BROKER, CONFIGURATION_MQTT_CONFIG
from constants import CONFIGURATION_MQTT_ENABLED, CONFIGURATION_MQTT_PREFIX, CONFIGURATION_RUN_CONFIG, CONFIGURATION_RUN_TEMP
from constants import CONFIGURATION_WIFI_CONFIG, CONFIGURATION_WIFI_ENABLED, CONFIGURATION_WIFI_HOSTNAME, CONFIGURATION_WIFI_SSID
from constants import CONFIGURATION_WIFI_PASSPHRASE, CONFIGURATION_WIFI_NTP_ENABLED, CONFIGURATION_WIFI_NTP_PTZ
...
class Configuration:
    ...
    def update_config_variables(self):
        ...
        self.show_status = self.config[CONFIGURATION_RUN_CONFIG][CONFIGURATION_RUN_SHOW_STATUS]
        self.status_period = self.config[CONFIGURATION_RUN_CONFIG][CONFIGURATION_RUN_STATUS_PERIOD]
